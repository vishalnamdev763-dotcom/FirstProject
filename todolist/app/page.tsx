...
const page = () => {
  ...
  let renderTask = <h2 className='flex justify-center text-5xl'>No Task Access</h2>
  ...
  return (
    <div>
      ...
      <form onSubmit={submitHandler}>
        ...
        <button className='bg-amber-950 text-white px-4 py-3 text-2xl font-bold rounded-2xl cursor-pointer'>Add Task</button>
      </form>
